...
export const products = [
  ...
  { id: 4, name: 'Furry Glow', category: 'Vitamins', price: 34.00, image: '/images/furryglow.png', description: 'Furry Glow is your dog’s daily beauty boost (without the bath). Created with vets and packed with Omega-3, 6, and 9 fatty acids, this supplement supports healthy skin and helps bring back that soft, full, pet-me coat we all love.', tags: ['health', 'coat'] },
